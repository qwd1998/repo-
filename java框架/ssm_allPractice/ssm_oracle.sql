...
select * from traveller where id in (select travellerId from order_traveller where order_traveller.orderid=3FE27DF2A4E44A6DBC5D0FE4651D3D3E)
...
insert into users values('1111','ccc@ddddd','admin','admin','13333333333',1);
insert into users values('2222','cccs@ddddd','user','user','13333335555',1);
insert into users values('3333','ccca@ddddd','tom','tom','13377333333',1);
...
insert into role values('0001','admin','好家伙');
insert into role values('0002','user','好家伙');
insert into role values('0003','uzzz','好家伙');
...
insert into users_role values('1111','0001');
insert into users_role values('1111','0002');
insert into users_role values('2222','0001');
insert into users_role values('2222','0002');
insert into users_role values('3333','0003');


select *from role where Id in (select roleId from users_role where userId = 1111 )
